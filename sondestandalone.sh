#!/bin/bash
#
# sondestandalone.sh: Starten des Sondenempfängers auf einem Standalone-System ohne grafische Oberfläche
#
...
#sleep 1
# Stick 2
#rtl_tcp -a 127.0.0.1 -d2 -p 18102 -n 1 &
#sleep 1
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
# Stick 0
sondeudp -f 16000 -o /home/pi/dxlAPRS/aprs/sondepipe0 -I MYCALL-11 -L SDR0 -u 127.0.0.1:18000 -c 0 -v -n 0 -W 5 & 
sleep 1
# Stick 1
#sondeudp -f 16000 -o /home/pi/dxlAPRS/aprs/sondepipe1 -I MYCALL-11 -L SDR1 -u 127.0.0.1:18000 -c 0 -v -n 0 -W 5 &
#sleep 1
# Stick 2
#sondeudp -f 16000 -o /home/pi/dxlAPRS/aprs/sondepipe2 -I MYCALL-11 -L SDR2 -u 127.0.0.1:18000 -c 0 -v -n 0 -W 5 &
#sleep 1
...
sleep 1
# Stick 1
#sdrtst -t 127.0.0.1:18101 -r 16000 -s /home/pi/dxlAPRS/aprs/sondepipe1 -Z 100 -c /home/pi/dxlAPRS/aprs/sdrcfg1.txt -e -k -v &
#sleep 1
# Stick 2
#sdrtst -t 127.0.0.1:18102 -r 16000 -s /home/pi/dxlAPRS/aprs/sondepipe2 -Z 100 -c /home/pi/dxlAPRS/aprs/sdrcfg2.txt -e -k -v &
#sleep 1
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
udpgate4 -s MYCALL-10 -R 127.0.0.1:0:9101 -B 1440 -u 50 -n 30:/home/pi/dxlAPRS/aprs/netbeacon.txt -g radiosondy.info:14580#m/1,-t/to -p PASSCODE -t 14580 -w 14501 -v -D /home/pi/dxlAPRS/aprs/www/ &
#
...
#udpgate4 -s MYCALL-10 -R 127.0.0.1:0:9101 -B 1440 -u 50 -A /home/pi/dxlAPRS/aprs/ -n 30:/home/pi/dxlAPRS/aprs/netbeacon.txt -g radiosondy.info:14580#m/1,-t/to -p PASSCODE -t 14580 -w 14501 -v -D /home/pi/dxlAPRS/aprs/www/ &