...
#xfce4-terminal --minimize --title UDPGATE4-Server2 -e 'bash -c "udpgate4 -s $IGATECALL -R 127.0.0.1:0:9102 -B 2880 -u 50 -H 0 -I 0 -L 0 -A $DXLPATH/ -n 30:$DXLPATH/netbeacon_sonde.txt -g server.adresse:14580#m/1 -p $PASSCODE -w 14502 -v -D $DXLPATH/www/"' &
